package dev.knowhowto.webfluxcrudsecured.service;

import java.util.List;
import java.util.function.BiFunction;

import dev.knowhowto.webfluxcrudsecured.dto.UserDepartmentDTO;
import dev.knowhowto.webfluxcrudsecured.entity.Department;
import dev.knowhowto.webfluxcrudsecured.entity.User;
import dev.knowhowto.webfluxcrudsecured.repository.DepartmentRepository;
import dev.knowhowto.webfluxcrudsecured.repository.UserRepository;
